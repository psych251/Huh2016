...
d <- read.csv("Replication_Huh2016_PilotB.csv")
...
# not all codes below apply. With only pilot data for N=5, not all "sub" vars have 2 levels, i.e. for sub1, all 5 participants chose the cross category item
...
# t tests for each set of stimuli in wide form. Here I've blocked off all codes that did not work and had the following message: "Error: Error in t.test.default(d$sim[], mu = 4) : data are essentially constant""
